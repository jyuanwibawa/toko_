                ...
                <div class="card-body">
                    ...
                    <?php 
                        ...
                        ?>
                                ...
                                <input type="hidden" name="id_pembeli" value="CUS-<?php echo $no+$jumlah; ?>">

                        <?php } ?>
                        <div class="input-group">
                            <label class="label">Nama</label>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <input class="input--style-4" type="text" name="nama_pembeli">
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email_pembeli">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Phone Number</label>
                                    <input class="input--style-4" type="number" name="telp_pembeli">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
