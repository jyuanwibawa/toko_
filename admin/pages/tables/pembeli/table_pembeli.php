                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="form_pembeli.php" class="btn btn-primary">Tambah Data</a>
                                <?php
                                $message = '';
                                if(isset($_GET["error"]))
                                {
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = "SELECT * FROM pembeli where deleted=0";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='form_edit_pembeli.php?id_pembeli=$id_pembeli' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_pembeli.php?id_pembeli=$id_pembeli' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
