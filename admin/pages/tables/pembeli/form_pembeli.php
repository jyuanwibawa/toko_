...
<head>
    ...
    <link href='../../../../images/bang.svg' rel='SHORTCUT ICON' />
    <title>Admin | ADMIN TOKO</title>
</head>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="table_pembeli.php">Data Pembeli</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Pembeli</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tables</a></li>
                                            <li class="breadcrumb-item"><a href="table_pembeli.php" class="breadcrumb-link">Data
                                                    Pembeli</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form Pembeli
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <h5 class="card-header">Data Pembeli</h5>
                            <div class="card-body">
                                <form action="process/add_pembeli.php" method="POST">

                                    <?php 
                                    $tampilkan_isi = "select count(id_pembeli) as jumlah from pembeli;";
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">ID Pembeli</label>
                                        <div class="col-md-9">
                                            <input type="text" name="id_pembeli" class="form-control" value="CUS-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" name="email_pembeli" class="form-control" placeholder="Email"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="telp_pembeli" class="form-control" placeholder="Nomor Telepon"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="table_pembeli.php"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright © 2018 BACOD'S STORE. All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
