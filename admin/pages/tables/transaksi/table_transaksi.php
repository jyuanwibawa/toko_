    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../../../dashboard.php">BADMIN TOKO</a>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                           $query = 
                                            "select t.id_transaksi,c.nama_pembeli,b.nama_barang,t.tgl_transaksi,t.jumlah,t.total from transaksi t,pembeli c,barang b
                                            where t.id_pembeli = c.id_pembeli AND
