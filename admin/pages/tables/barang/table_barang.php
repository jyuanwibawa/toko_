                            ...
                            <div class="card-body">
                                ...
                                <table id="tabell" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT b.id_barang,b.nama_barang,b.stok,b.gambar,b.deleted from barang b WHERE 
                                            b.deleted = 0 ORDER BY b.id_barang";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='form_edit_barang.php?id_barang=$id_barang' class='btn btn-warv ning'>Update</a>
                                                            <a href='process/delete_game.php?id_barang=$id_barang' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
