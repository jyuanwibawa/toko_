...
$query = "SELECT * FROM barang WHERE id_game = '$id_game'";
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../game/table_barang.php">Data Barang</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="../pembeli/table_pembeli.php">Data Pembeli</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="table_game.php" class="breadcrumb-link">Data
                                                    Barang</a></li>
                    ...
                    <form action="process/edit_game.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="card">
                                    <h5 class="card-header">Gambar Barang</h5>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="id_game" class="form-control" value="<?php echo $id_game ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="nama_game" class="form-control" placeholder="nama barang"
                                                    value="<?php echo $item['nama_game'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-5">
                                            <div class="col-md-6">
                                                ...
                                                <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg"
                                                    href="table_game.php" role="button">Kembali</a>
                                            </div>
