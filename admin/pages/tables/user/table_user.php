    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../../../dashboard.php">ADMIN TOKOs</a>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT * FROM user where tipe_user='pembeli' AND deleted=0 ORDER BY id_pembeli";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>******</td>
                                                        <td>
                                                            <a href='form_edit_user.php?id_pembeli=$id_pembeli' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_user.php?id_pembeli=$id_pembeli' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
