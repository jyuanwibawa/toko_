                            ...
                            <div class="card-body">
                                <form action="process/add_user.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select required name="id_pembeli" class="form-control">
                                                <option value="" disabled selected>--</option>
                                                <?php 
                                                $tampilkan_isi = "select pembeli.id_pembeli,pembeli.nama_pembeli from user
                                                RIGHT OUTER JOIN pembeli
                                                ON user.id_pembeli = pembeli.id_pembeli
                                                WHERE user.id_pembeli IS NULL";
                                                $tampilkan_isi_sql = mysqli_query($con,$tampilkan_isi);
                                            
                                                while ($isi = mysqli_fetch_array($tampilkan_isi_sql))
                                                {
                                                    echo "<option value='".$isi['id_pembeli']."'>".$isi['nama_pembeli']."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
