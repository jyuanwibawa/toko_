...
$query = "select u.id_pembeli,c.nama_pembeli,u.username,u.password from user u,pembeli c where u.id_pembeli = '$id_pembeli'
AND u.id_pembeli = c.id_pembeli";
                            ...
                            <div class="card-body">
                                <form action="process/edit_user.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="pembeli" class="form-control" value="<?php echo $item['nama_pembeli']; ?>"
                                                readonly>
                                        </div>
                                    </div>
