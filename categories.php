	...
	<div class="super_container">
		...
		<div class="home">
			<div class="home_container">
				<div class="home_background" style="background-image:url(images/sembako2.jpg)"></div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col">
						...
						<?php
								$query = 
								"select * from barang b,kategori p
								where b.id_kategori =p.id_kategori ANd b.id_kategori= '$kategori_terpilih'";
